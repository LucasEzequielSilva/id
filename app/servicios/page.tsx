      ...
      <section className="pt-36 pb-28">
        <div className="container mx-auto px-4 md:px-8">
          <motion.div className="max-w-2xl mx-auto text-center" initial="hidden" animate="visible" variants={fadeIn}>
            ...
            <h1 className="text-2xl md:text-3xl tracking-tight text-[#1A1A18] font-medium mb-6 leading-[1.1]">
              {t("servicesPage.hero.title")}
            </h1>
            <p className="text-lg text-[#6B6B66] mb-10 leading-relaxed">{t("servicesPage.hero.subtitle")}</p>
