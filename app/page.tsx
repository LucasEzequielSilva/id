...
export default function Home() {
  ...
  const features = [
    { icon: Scale, label: t("about.features.legal"), image: "/images/centro-id/about/legal.png" },
    { icon: Shield, label: t("about.features.confidentiality"), image: "/images/centro-id/about/confidentiality.png" },
    { icon: GraduationCap, label: t("about.features.certified"), image: "/images/centro-id/about/certified.png" },
    { icon: Globe2, label: t("about.features.global"), image: "/images/centro-id/about/global.png" },
  ]
