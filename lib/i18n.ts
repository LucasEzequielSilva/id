...
export const translations = {
  es: {
    ...
    hero: {
      schedule: "AGENDA DE",
      open: "ABIERTA",
      title: "Tu espacio de bienestar psicológico",
      subtitle: "Brindamos terapia y servicios periciales adaptados a tus necesidades, estés donde estés.",
    ...
    services: {
      ...
      items: {
        ...
        digital: {
          title: "Pericias Digitales",
          description: "Evaluaciones psicológicas online y presenciales con respaldo legal.",
        },
      },
    },
    contact: {
    ...
    whyChooseUs: {
      ...
      description:
        "Nuestro compromiso es brindar servicios profesionales de la más alta calidad, combinando experiencia, tecnología y un enfoque centrado en el cliente.",
      features: {
        professional: {
          title: "Excelencia Profesional",
          description: "Años de experiencia y educación continua para brindar la mejor atención.",
        },
        personalized: {
          title: "Enfoque Personalizado",
          description: "Cada individuo es único, y así es nuestro enfoque hacia su proceso.",
        },
        confidentiality: {
        ...
        innovation: {
          ...
          description: "Incorporamos las últimas investigaciones y tecnologías en nuestros servicios.",
        },
      },
    },
    videoSection: {
    ...
    aboutPage: {
      ...
      team: {
        ...
        founder: {
          ...
          bio: "Psicóloga especializada en psicología forense con más de 35 años de experiencia en evaluaciones psicológicas y pericias. Líder del equipo de CENTRO PERICIAL PSICOLOGICO ID.",
          registration: "Matrícula Provincial: 098 | Matrícula Nacional: 239330",
        },
      },
      values: {
  ...
  en: {
    ...
    hero: {
      ...
      subtitle: "We provide therapy and expert witness services tailored to your needs, no matter where you are.",
    ...
    services: {
      ...
      items: {
        ...
        digital: {
          ...
          description: "Online and in-person psychological evaluations with legal support.",
        },
      },
    },
    contact: {
    ...
    whyChooseUs: {
      title: "Why Choose Us",
      description:
        "Our commitment is to provide professional services of the highest quality, combining experience, technology, and a client-centered approach.",
      features: {
        professional: {
          title: "Professional Excellence",
          description: "Years of experience and continuous education to provide the best care.",
        },
        personalized: {
          title: "Personalized Approach",
          description: "Every individual is unique, and so is our approach to their process.",
        },
        confidentiality: {
          title: "Total Confidentiality",
          description: "We guarantee the privacy and security of all information.",
        },
        innovation: {
          title: "Constant Innovation",
          description: "We incorporate the latest research and technologies into our services.",
        },
      },
    },
    videoSection: {
    ...
    aboutPage: {
      hero: {
        title: "About PSYCHOLOGICAL EXPERT CENTER ID",
        subtitle: "Professional psychological services with a focus on precision and trust",
      },
      mission: {
        title: "Our Mission",
        description:
          "At PSYCHOLOGICAL EXPERT CENTER ID, we are committed to providing high-quality psychological services that empower individuals to overcome challenges, achieve personal growth, and improve their overall well-being. Our approach combines scientific rigor with empathetic understanding, ensuring that each client receives personalized care tailored to their unique needs.",
      },
      team: {
        title: "Our Team",
        description:
          "Our team of certified professionals brings years of experience and continuous education to provide the best possible care.",
        founder: {
          name: "Lic. Alejandra del Valle Peralta",
          role: "Founder and Director",
          bio: "Psychologist specialized in forensic psychology with over 35 years of experience in psychological evaluations and expert witness services. Leader of the PSYCHOLOGICAL EXPERT CENTER ID team.",
          registration: "Provincial Registration: 098 | National Registration: 239330",
        },
      },
      values: {
        title: "Our Values",
